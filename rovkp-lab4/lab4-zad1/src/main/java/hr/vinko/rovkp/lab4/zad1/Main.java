...
public class Main {
	...
	private static final String DEF_OUT = "../data/pollutionData-all.csv";
	...
	public static void main(String[] args) throws IOException {
		...
		try (Writer writer = new BufferedWriter(new FileWriter(DEF_OUT))) {
			...
			allLines.filter(line -> PollutionReading.isParseable(line.split(","))).map(line -> new PollutionReading(line))
